      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Profil İsmi',style: TextStyle(fontWeight: FontWeight.bold,color:Colors.white)),
            SizedBox(height: 10.0),
            isimField,
            SizedBox(height: 10.0),
            Text('Şifre',style: TextStyle(fontWeight: FontWeight.bold,color:Colors.white)),
            SizedBox(height: 10.0),
            sifreField,
            SizedBox(height: 10.0),
            Text('Konum',style: TextStyle(fontWeight: FontWeight.bold,color:Colors.white)),
            SizedBox(height: 10.0),
            konumField,
